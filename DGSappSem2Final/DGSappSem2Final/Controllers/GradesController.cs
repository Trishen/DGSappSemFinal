...
namespace DGSappSem2Final.Controllers
{
    public class GradesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GradeId,GradeName,MaxNoOfStudentsInGrade,MaxNoOfClasses,MaxNoOfStudentsPerClass")] Grades grades)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GradeId,GradeName,MaxNoOfStudentsInGrade,MaxNoOfClasses,MaxNoOfStudentsPerClass")] Grades grades)
        {
            if (ModelState.IsValid)
            {
